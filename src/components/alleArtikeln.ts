    ...
    speisen: [
      {
        ...
        items: [
          ...
          { id: 3, name: "Gambas Al Aioli", price: 15.90 },
          { id: 4, name: "Carpaccio", price: 13.50 },
        ],
      },
      {
        name: "Salate",
      ...
      },
      {
        name: "Steaks",
        items: [
          { id: 11, name: "Hüftsteak 200gr", price: 20.90 },
          { id: 12, name: "Hüftsteak 300gr", price: 29.90 },
          { id: 13, name: "Hüftsteak 500gr", price: 44.90 },
          { id: 14, name: "Rumpsteak 200gr", price: 25.90 },
          { id: 15, name: "Rumpsteak 300gr", price: 34.90 },
          { id: 16, name: "Rumpsteak 500gr", price: 49.90 },
          { id: 17, name: "Ribeye Steak 250gr", price: 27.90 },
          { id: 18, name: "Ribeye Steak 350gr", price: 34.90 },
          { id: 19, name: "Ribeye Steak 500gr", price: 49.90 },
          { id: 20, name: "Super Cut 230gr", price: 29.90 },
          { id: 21, name: "Super Cut 450gr", price: 51.90 },
          { id: 22, name: "Filet Steak 200gr", price: 29.90 },
          { id: 22, name: "Filet Steak 300gr", price: 39.50 },
          { id: 23, name: "Filet Steak 400gr", price: 52.50 },
          { id: 24, name: "Sirloin Filet 200gr", price: 23.90 },
          { id: 24, name: "Sirloin Filet 300gr", price: 31.90 },
          { id: 25, name: "Sirloin Filet 400gr", price: 43.90 },
          { id: 26, name: "Dry Aged Rumpsteak", price: 39.90 },
          { id: 27, name: "Dry Aged Entrecôte", price: 41.90 },
          { id: 28, name: "Dry Aged Filet", price: 47.90 },
          { id: 28, name: "T-Bone Steak", price: 55.90 },
        ],
      },
      {
        name: "Bistro",
        items: [
          ...
          { id: 19, name: "Rinderhacksteak", price: 14.90 },
          { id: 20, name: "Steakstreifen", price: 16.90 },
          { id: 22, name: "Country Potato", price: 15.90 },
          { id: 23, name: "Beef Potato", price: 16.90 },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 26, name: "Champignon Steak 200gr", price: 22.90 },
          { id: 26, name: "Champignon Steak 300gr", price: 31.90 },
          { id: 27, name: "Holzfällersteak", price: 18.90 },
          { id: 28, name: "Spare Ribs", price: 20.90 },
          { id: 25, name: "Pfeffersteak 200gr", price: 24.90 },
          { id: 25, name: "Pfeffersteak 300gr", price: 33.90 },
          { id: 26, name: "Mendoza Grillteller", price: 22.50 },
      ...
      },
      {
        name: "Fisch",
        items: [
          { id: 27, name: "Lachsfilet", price: 24.90 },
          { id: 28, name: "Zanderfilet", price: 25.90 },
          { id: 27, name: "Mendoza Fischplatte", price: 27.90 },
        ],
      },
      {
        name: "Burger Mania",
        items: [
          ...
          { id: 28, name: "Royal Burger 320gr", price: 18.90 },
          { id: 27, name: "Champi Burger 160gr", price: 15.90 },
          { id: 28, name: "Champi Burger 320gr", price: 19.90 },
          { id: 27, name: "Hawaii Burger 160gr", price: 14.90 },
          { id: 28, name: "Hawaii Burger 320gr", price: 17.50 },
          { id: 27, name: "Chili-Cheese 160gr", price: 15.90 },
          { id: 28, name: "Chili-Cheese 320gr", price: 19.90 },
          { id: 27, name: "Bacon Burger 160gr", price: 15.90 },
          { id: 28, name: "Bacon Burger 320gr", price: 19.90 },
          { id: 27, name: "Giant Burger 160gr", price: 14.90 },
          { id: 28, name: "Giant Burger 320gr", price: 18.90 },
          { id: 27, name: "Big Danmark 160gr", price: 15.90 },
          { id: 28, name: "Big Danmark 320gr", price: 19.90 },
          { id: 27, name: "Onion Crisp 160gr", price: 16.90 },
          { id: 28, name: "Onion Crisp 320gr", price: 19.90 },
          { id: 27, name: "Dry Aged 160gr", price: 17.90 },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 28, name: "Apfelstrudel", price: 7.90 },
      ...
      },
      {
        name: "Angebote",
        items: [
          { id: 28, name: "Büsumer", price: 9.90 },
          { id: 27, name: "Scampi D.C. Pfanne", price: 23.90 },
          { id: 28, name: "Gänsekuele", price: 29.90 },
          { id: 27, name: "Hirschsteak", price: 28.90 },
          { id: 28, name: "Theo Evermann Spare Ribs", price: 25.90 },
          { id: 27, name: "Kaiserschmarrn", price: 8.50 },
          { id: 27, name: "Gebackene Champignons", price: 8.90 },
          { id: 28, name: "Mexican Burger", price: 22.90 },
          { id: 27, name: "Kalbsleber", price: 23.90 },
          { id: 28, name: "Schweinebraten", price: 24.90 },
        ],
      },
      {
        name: "Beilagen",
        items: [
          ...
          { id: 27, name: "Country Potatoes", price: 5.00 },
    ...
    getraenke: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 13, name: "Coca Cola 0,4l", price: 4.90 },
          { id: 12, name: "Coca Cola Zero 0,4l", price: 4.90 },
          { id: 13, name: "Fanta 0,4l", price: 4.90 },
          { id: 12, name: "Sprite 0,4l", price: 4.90 },
          { id: 13, name: "Mezzo Mix 0,4l", price: 4.90 },
          { id: 12, name: "Bitter Lemon 0,4l", price: 5.50 },
          { id: 13, name: "Ginger Ale 0,4l", price: 5.50 },
          { id: 13, name: "Tonic Water 0,4l", price: 5.50 },
      ...
      },
      {
        name: "Biere vom Fass",
        items: [
          { id: 12, name: "Pils 0,3l", price: 4.00 },
          { id: 13, name: "Pils 0,5l", price: 5.90 },
          { id: 12, name: "Dunkelbier 0,3l", price: 4.00 },
          { id: 13, name: "Dunkelbier 0,5l", price: 5.90 },
          { id: 12, name: "Alsterwasser 0,3l", price: 4.00 },
          { id: 13, name: "Alsterwasser 0,5l", price: 5.90 },
          { id: 12, name: "Krefelder 0,3l", price: 4.00 },
          { id: 13, name: "Krefelder 0,5l", price: 5.90 },
          { id: 12, name: "Kellerbier 0,3l", price: 4.00 },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 12, name: "Vitamalz", price: 4.00 },
          { id: 13, name: "Alkfr. Weizen", price: 5.90 },
          { id: 12, name: "Alkfr. Pils", price: 4.00 },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 12, name: "Hennessy 4cl", price: 8.50 },
          ...
          { id: 13, name: "DP Pistaccio", price: 4.00 },
          { id: 12, name: "DP Limoncello", price: 4.00 },
          { id: 13, name: "DP Espresso Martini", price: 4.00 },
          { id: 13, name: "DP Nocciola", price: 4.00 },
        ],
      },
      {
        name: "Aperitif",
        items: [
          ...
          { id: 12, name: "Aperitivo Spritz", price: 7.50 },
          { id: 13, name: "Aperitivo Bitter Lemon Spritz", price: 7.50 },
          { id: 12, name: "Limoncello Spritz", price: 7.50 },
          { id: 13, name: "Limoncello Wildberry Spritz", price: 7.50 },
          { id: 12, name: "HH Aperitivo Spritz", price: 5.50 },
          { id: 13, name: "HH Aperitivo Bitter Lemon Spritz", price: 5.50 },
          { id: 12, name: "HH Limoncello Spritz", price: 5.50 },
          { id: 13, name: "HH Limoncello Wildberry Spritz", price: 5.50 },
        ],
      },
      {
        name: "Spirits",
        items: [
          ...
          { id: 13, name: "Needle Masterpiece Gin 4cl", price: 6.00 },
          { id: 12, name: "Jack Daniel's 4cl", price: 5.00 },
          { id: 13, name: "Vodka 4cl", price: 5.00 },
          ...
          { id: 12, name: "Evermann Theo Whisky 4cl", price: 5.00 },
          { id: 13, name: "Evermann Wilhelm Whisky 4cl", price: 7.00 },
        ],
      },
      {
        name: "Schaumweine",
      ...
      },
      {
        name: "Weißweine",
        items: [
          { id: 12, name: "Weißburgunder 0,2l", price: 7.50 },
          { id: 13, name: "Weißburgunder 0,5l", price: 16.50 },
          { id: 12, name: "Weißburgunder 1l", price: 30.00 },
          { id: 13, name: "Chardonnay 0,2l", price: 7.90 },
          { id: 12, name: "Chardonnay 0,5l", price: 17.50 },
          { id: 13, name: "Chardonnay 0,75l", price: 24.50 },
          { id: 12, name: "Sauvignon Blanc 0,2l", price: 8.50 },
          { id: 13, name: "Sauvignon Blanc 0,5l", price: 20.50 },
          { id: 12, name: "Sauvignon Blanc 0,75l", price: 28.90 },
          { id: 13, name: "Weinschorle 0,2l", price: 5.50 },
          { id: 13, name: "Weinschorle 0,5l", price: 11.90 },
        ],
      },
      {
        name: "Rotweine",
        items: [
          { id: 12, name: "Tempr. Crianza 0,2l", price: 6.90 },
          { id: 13, name: "Tempr. Crianza 0,5l", price: 15.50 },
          { id: 12, name: "Tempr. Crianza 0,75l", price: 21.90 },
          { id: 13, name: "Cabernet Sauv. 0,2l", price: 7.50 },
          { id: 12, name: "Cabernet Sauv. 0,5l", price: 17.50 },
          { id: 13, name: "Cabernet Sauv. 0,75l", price: 24.90 },
          { id: 12, name: "Shiraz 0,2l", price: 8.00 },
          { id: 13, name: "Shiraz 0,5l", price: 18.50 },
          { id: 12, name: "Shiraz 0,75l", price: 26.50 },
          { id: 13, name: "Carménère 0,2l", price: 8.90 },
          { id: 12, name: "Carménère 0,5l", price: 19.90 },
          { id: 13, name: "Carménère 0,75l", price: 28.90 },
        ],
      },
      {
        name: "Rosé Weine",
        items: [
          { id: 12, name: "Portugieser Rosé 0,2l", price: 7.40 },
          { id: 13, name: "Portugieser Rosé 0,5l", price: 15.50 },
          { id: 12, name: "Portugieser Rosé 1l", price: 28.50 },
          { id: 13, name: "Petite Rosée 0,2l", price: 7.80 },
          { id: 12, name: "Petite Rosée 0,5l", price: 16.50 },
          { id: 13, name: "Petite Rosée 0,75l", price: 23.50 },
        ],
      },
      {
        name: "Heiße Getränke",
        items: [
          ...
          { id: 13, name: "Glühwein", price: 6.50 },
          { id: 13, name: "Limoncello Hot Don", price: 6.50 },
        ],
      },
    ],
  };
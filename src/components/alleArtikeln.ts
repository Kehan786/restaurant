...
export const initialMenu = {
    speisen: [
      ...
      },
      {
        name: "Angebote",
        items: [
          { id: 28, name: "6 Butterfly Shrimps", price: 7.90 },
          { id: 27, name: "Pfifferlinge", price: 13.90 },
          { id: 28, name: "Rumpsteak", price: 27.90 },
          { id: 27, name: "Ratsherrn Teller", price: 28.90 },
          { id: 28, name: "Viererlei Filet", price: 39.90 },
          { id: 27, name: "Diya Teller", price: 24.90 },
          { id: 27, name: "1. Kombination", price: 15 },
          { id: 28, name: "2. Kombination", price: 15 },
          { id: 27, name: "3. Kombination", price: 15 },
    ...
    getraenke: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 13, name: "Bierprobe", price: 8.90 },
        ],
      },
      {
        name: "Fl. Biere",
